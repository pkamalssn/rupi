...
ActiveRecord::Schema[7.2].define(version: 2026_01_13_000001) do
  ...
  create_table "category_rules", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "probationary", default: true
    t.string "scope", default: "narration"
    t.uuid "account_id"
    t.datetime "last_overridden_at"
    t.string "pattern_hash_exact"
    ...
    t.index ["family_id", "category_id"], name: "index_category_rules_on_family_id_and_category_id"
    t.index ["family_id", "pattern"], name: "index_category_rules_on_family_id_and_pattern", unique: true
    t.index ["family_id", "pattern_hash_exact"], name: "index_category_rules_on_family_id_and_pattern_hash_exact"
    t.index ["family_id", "status", "priority"], name: "index_category_rules_on_family_id_and_status_and_priority", order: { priority: :desc }
    t.index ["family_id", "status", "scope"], name: "idx_rules_scope_lookup"
  ...
  create_table "emi_payments", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "loan_id", null: false
    t.uuid "entry_id", comment: "Linked transaction"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["due_date"], name: "index_emi_payments_on_due_date"
    t.index ["entry_id"], name: "index_emi_payments_on_entry_id"
    t.index ["loan_id", "due_date"], name: "index_emi_payments_on_loan_id_and_due_date", unique: true
    t.index ["loan_id"], name: "index_emi_payments_on_loan_id"
    t.index ["status"], name: "index_emi_payments_on_status"
  end
  ...
  create_table "imports", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "categorization_status"
    t.string "categorization_job_id"
    t.integer "categorized_count", default: 0
    t.integer "total_to_categorize", default: 0
    t.index ["bank_name"], name: "index_imports_on_bank_name"
    t.index ["categorization_status"], name: "index_imports_on_categorization_status"
  ...
  create_table "loan_document_imports", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "family_id", null: false
    t.uuid "account_id"
    t.string "status", default: "pending", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_loan_document_imports_on_account_id"
    t.index ["family_id"], name: "index_loan_document_imports_on_family_id"
    t.index ["status"], name: "index_loan_document_imports_on_status"
  end
  ...
  create_table "loans", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.jsonb "locked_attributes", default: {}
    t.string "subtype"
    t.integer "emi_day", comment: "Day of month when EMI is debited (1-28)"
    t.string "lender_name", comment: "Bank/NBFC name"
    t.string "loan_account_number", comment: "Loan account number"
    t.date "disbursement_date", comment: "When loan was disbursed"
    t.decimal "actual_emi"
  end
  ...
  add_foreign_key "loan_document_imports", "accounts"
  add_foreign_key "loan_document_imports", "families"
