Rails.application.routes.draw do
  # US/EU bank connections removed - using Indian bank statement uploads instead
  ...
  # GoodJob dashboard - mounted with authentication (configured below)
  ...
  # Bank statement uploads for Indian banks
  resource :bank_statement, only: %i[new create]
  ...
  # AI-powered loan document import
  resources :loan_document_imports, only: %i[new create show update destroy] do
    member do
      get :review
      post :publish
    end
  ...
  # Privacy and Terms are now shown as inline modals in the footer
