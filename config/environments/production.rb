...
Rails.application.configure do
  ...
  # Use Resend HTTP API (SMTP ports often blocked on cloud platforms)
  ...
  # GoodJob: PostgreSQL-backed async job processing
  # Runs INSIDE the Puma process - no separate worker needed!
  # This eliminates the $7/mo worker cost on Render.com
