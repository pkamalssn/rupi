...
class Demo::Generator
  ...
  def generate_default_data!(skip_clear: false, email: "user@example.com")
    ...
    with_timing(__method__, max_seconds: 1000) do
      ...
      create_indian_categories!(family)
      create_indian_accounts!(family)
      create_indian_transactions!(family)
  ...
  private
    ...
    def generate_budget_auto_fill!(family)
      ...
      spend_per_cat.each do |cat_id, total|
        avg = total / 3.0
        rounded = ((avg / 500.0).round) * 500  # Round to nearest ₹500
    ...
    # ---------------------------------------------------------------------------
    # Indian Demo Data Generation
    # ---------------------------------------------------------------------------

    def create_indian_categories!(family)
      # Income categories
      @salary_cat = family.categories.create!(name: "Salary", color: "#10b981", classification: "income")
      @freelance_cat = family.categories.create!(name: "Freelance Income", color: "#059669", classification: "income")
      @investment_income_cat = family.categories.create!(name: "Investment Income", color: "#047857", classification: "income")
      @rental_income_cat = family.categories.create!(name: "Rental Income", color: "#065f46", classification: "income")

      # Expense categories - Indian specific
      @food_cat = family.categories.create!(name: "Food & Dining", color: "#ea580c", classification: "expense")
      @groceries_cat = family.categories.create!(name: "Groceries", parent: @food_cat, color: "#c2410c", classification: "expense")
      @dining_out_cat = family.categories.create!(name: "Dining Out", parent: @food_cat, color: "#9a3412", classification: "expense")
      @swiggy_cat = family.categories.create!(name: "Swiggy/Zomato", parent: @food_cat, color: "#7c2d12", classification: "expense")

      @shopping_cat = family.categories.create!(name: "Shopping", color: "#8b5cf6", classification: "expense")
      @amazon_cat = family.categories.create!(name: "Amazon/Flipkart", parent: @shopping_cat, color: "#7c3aed", classification: "expense")
      @clothing_cat = family.categories.create!(name: "Clothing", parent: @shopping_cat, color: "#6d28d9", classification: "expense")

      @transport_cat = family.categories.create!(name: "Transportation", color: "#3b82f6", classification: "expense")
      @petrol_cat = family.categories.create!(name: "Petrol/Fuel", parent: @transport_cat, color: "#2563eb", classification: "expense")
      @uber_cat = family.categories.create!(name: "Uber/Ola/Auto", parent: @transport_cat, color: "#1d4ed8", classification: "expense")
      @metro_cat = family.categories.create!(name: "Metro/Train", parent: @transport_cat, color: "#1e40af", classification: "expense")

      @utilities_cat = family.categories.create!(name: "Utilities & Bills", color: "#f59e0b", classification: "expense")
      @electricity_cat = family.categories.create!(name: "Electricity", parent: @utilities_cat, color: "#d97706", classification: "expense")
      @mobile_cat = family.categories.create!(name: "Mobile/Internet", parent: @utilities_cat, color: "#b45309", classification: "expense")
      @dth_cat = family.categories.create!(name: "DTH/Netflix", parent: @utilities_cat, color: "#92400e", classification: "expense")

      @healthcare_cat = family.categories.create!(name: "Healthcare", color: "#ec4899", classification: "expense")
      @medicines_cat = family.categories.create!(name: "Medicines", parent: @healthcare_cat, color: "#db2777", classification: "expense")
      @doctor_cat = family.categories.create!(name: "Doctor/Hospital", parent: @healthcare_cat, color: "#be185d", classification: "expense")

      @education_cat = family.categories.create!(name: "Education", color: "#06b6d4", classification: "expense")

      @investments_cat = family.categories.create!(name: "Investments & Savings", color: "#14b8a6", classification: "expense")
      @sip_cat = family.categories.create!(name: "Mutual Fund SIP", parent: @investments_cat, color: "#0d9488", classification: "expense")
      @ppf_cat = family.categories.create!(name: "PPF/EPF", parent: @investments_cat, color: "#0f766e", classification: "expense")

      @loan_cat = family.categories.create!(name: "Loan Payments", color: "#f97316", classification: "expense")
      @home_loan_emi_cat = family.categories.create!(name: "Home Loan EMI", parent: @loan_cat, color: "#ea580c", classification: "expense")
      @personal_loan_emi_cat = family.categories.create!(name: "Personal Loan EMI", parent: @loan_cat, color: "#c2410c", classification: "expense")

      @tax_cat = family.categories.create!(name: "Taxes", color: "#ef4444", classification: "expense")

      @misc_cat = family.categories.create!(name: "Miscellaneous", color: "#6b7280", classification: "expense")
    end

    def create_indian_accounts!(family)
      # Indian bank accounts (INR)
      @hdfc_savings = family.accounts.create!(accountable: Depository.new, name: "HDFC Savings", balance: 0, currency: "INR")
      @icici_salary = family.accounts.create!(accountable: Depository.new, name: "ICICI Salary Account", balance: 0, currency: "INR")
      @sbi_current = family.accounts.create!(accountable: Depository.new, name: "SBI Current Account", balance: 0, currency: "INR")

      # Indian credit cards
      @hdfc_card = family.accounts.create!(accountable: CreditCard.new, name: "HDFC Credit Card", balance: 0, currency: "INR")
      @icici_amex = family.accounts.create!(accountable: CreditCard.new, name: "ICICI Amazon Pay Card", balance: 0, currency: "INR")

      # Indian investment accounts
      @zerodha = family.accounts.create!(accountable: Investment.new, name: "Zerodha Demat", balance: 0, currency: "INR")
      @mf_central = family.accounts.create!(accountable: Investment.new, name: "MF Central", balance: 0, currency: "INR")
      @ppf_account = family.accounts.create!(accountable: Investment.new, name: "PPF Account", balance: 0, currency: "INR")
      @epf_account = family.accounts.create!(accountable: Investment.new, name: "EPF Account", balance: 0, currency: "INR")

      # Indian loans
      @home_loan = family.accounts.create!(accountable: Loan.new, name: "Home Loan - HDFC", balance: 0, currency: "INR")
      @car_loan = family.accounts.create!(accountable: Loan.new, name: "Car Loan - SBI", balance: 0, currency: "INR")

      # Property (India)
      @flat = family.accounts.create!(accountable: Property.new, name: "Apartment", balance: 0, currency: "INR")

      # Vehicle
      @car = family.accounts.create!(accountable: Vehicle.new, name: "Honda City", balance: 0, currency: "INR")

      # Digital gold
      @digital_gold = family.accounts.create!(accountable: OtherAsset.new, name: "Digital Gold", balance: 0, currency: "INR")
    end

    def create_indian_transactions!(family)
      # Salary credits (last 6 months, bi-monthly)
      6.times do |i|
        date = 6.months.ago.to_date + (i * 1.month)
        amount = -85_000  # ₹85,000 salary
        create_transaction!(@icici_salary, amount, "Salary - ABC Corp", @salary_cat, date)
      end

      # Freelance income
      3.times do
        date = rand(1..90).days.ago.to_date
        amount = -rand(15_000..35_000)
        create_transaction!(@hdfc_savings, amount, "Freelance Project Payment", @freelance_cat, date)
      end

      # Rental income
      6.times do |i|
        date = 6.months.ago.to_date + (i * 1.month)
        amount = -18_000  # ₹18,000 rent
        create_transaction!(@hdfc_savings, amount, "Rent Received", @rental_income_cat, date)
      end

      # Groceries (BigBasket, local stores)
      30.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(1_500..5_000)
        stores = ["BigBasket", "Blinkit", "D-Mart", "Local Kirana", "Reliance Fresh"]
        create_transaction!(@hdfc_savings, amount, stores.sample, @groceries_cat, date)
      end

      # Food delivery (Swiggy, Zomato)
      25.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(300..1_500)
        apps = ["Swiggy", "Zomato", "Swiggy Instamart"]
        create_transaction!(@hdfc_card, amount, apps.sample, @swiggy_cat, date)
      end

      # Dining out
      15.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(800..2_500)
        restaurants = ["Barbeque Nation", "Pizza Hut", "Domino's", "Chai Point", "Local Cafe"]
        create_transaction!(@hdfc_card, amount, restaurants.sample, @dining_out_cat, date)
      end

      # Online shopping (Amazon, Flipkart, Myntra)
      20.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(500..8_000)
        stores = ["Amazon", "Flipkart", "Myntra", "AJIO", "Cred", "Blinkit"]
        create_transaction!(@hdfc_card, amount, stores.sample, @amazon_cat, date)
      end

      # Petrol
      15.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(2_000..5_000)
        create_transaction!(@hdfc_savings, amount, "Petrol - HP/Indian Oil", @petrol_cat, date)
      end
      ...
      20.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(100..800)
        apps = ["Uber", "Ola", "Rapido", "Auto Rickshaw"]
        create_transaction!(@hdfc_card, amount, apps.sample, @uber_cat, date)
      end
      ...
      10.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(50..200)
        create_transaction!(@hdfc_savings, amount, "Metro/Train", @metro_cat, date)
      end

      # Electricity bill
      6.times do |i|
        date = 6.months.ago.to_date + (i * 1.month)
        amount = rand(2_000..4_000)
        create_transaction!(@hdfc_savings, amount, "Electricity - MGVCL", @electricity_cat, date)
      end

      # Mobile/Internet
      6.times do |i|
        date = 30.days.ago.to_date + (i * 30).days
        amount = rand(600..1_200)
        providers = ["Jio Fiber", "Airtel", "Vi", "Jio Mobile"]
        create_transaction!(@hdfc_savings, amount, providers.sample, @mobile_cat, date)
      end

      # DTH/Netflix/Spotify
      6.times do |i|
        date = 30.days.ago.to_date + (i * 30).days
        amount = rand(500..1_500)
        providers = ["Netflix", "Spotify", "Hotstar", "Tata Play"]
        create_transaction!(@hdfc_card, amount, providers.sample, @dth_cat, date)
      end

      # Medicines
      8.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(200..2_000)
        pharmacies = ["Apollo Pharmacy", "Practo", "Local Medical", "1mg"]
        create_transaction!(@hdfc_savings, amount, pharmacies.sample, @medicines_cat, date)
      end

      # Doctor/Hospital
      3.times do
        date = rand(1..90).days.ago.to_date
        amount = rand(500..5_000)
        create_transaction!(@hdfc_savings, amount, "Doctor/Hospital Visit", @doctor_cat, date)
      end

      # SIP investments
      6.times do |i|
        date = 6.months.ago.to_date + (i * 1.month)
        amount = rand(10_000..25_000)
        create_transaction!(@hdfc_savings, amount, "SIP - Parag Parikh Flexi Cap", @sip_cat, date)
      end

      # PPF investment
      4.times do |i|
        date = 4.months.ago.to_date + (i * 1.month)
        amount = rand(20_000..50_000)
        create_transaction!(@hdfc_savings, amount, "PPF Deposit", @ppf_cat, date)
      end

      # Home Loan EMI
      6.times do |i|
        date = 6.months.ago.to_date + (i * 1.month)
        amount = 35_000  # ₹35,000 EMI
        create_transaction!(@hdfc_savings, amount, "Home Loan EMI - HDFC", @home_loan_emi_cat, date)
        # Principal portion reduces loan balance
        create_transaction!(@home_loan, -15_000, "Principal Payment", nil, date)
      end
      ...
      6.times do |i|
        date = 6.months.ago.to_date + (i * 1.month)
        amount = 25_000
        create_transaction!(@hdfc_savings, amount, "HDFC Card Payment", @loan_cat, date)
      end

      # Property valuation
      @flat.entries.create!(
        entryable: Valuation.new(kind: "current_anchor"),
        amount: 75_00_000,  # ₹75 lakhs
        name: Valuation.build_current_anchor_name(@flat.accountable_type),
        currency: "INR",
        date: Date.current
      )
      ...
      @car.entries.create!(
        entryable: Valuation.new(kind: "current_anchor"),
        amount: 8_00_000,  # ₹8 lakhs
        name: Valuation.build_current_anchor_name(@car.accountable_type),
        currency: "INR",
        date: Date.current
      )

      puts "   ✅ Generated Indian demo transactions"
    end
end
