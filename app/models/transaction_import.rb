class TransactionImport < Import
  def import!
    transaction do
      ...
      affected_accounts = Set.new # Track accounts affected by this import
      ...
      rows.each_with_index do |row, index|
        ...
        # Track affected accounts for sync
        affected_accounts.add(mapped_account)
      ...
      # Trigger sync for all affected accounts to recalculate balances
      affected_accounts.each do |acct|
        acct.sync_later
      end
    end
  end
